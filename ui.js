...
class UiController {
  ...
  buildFilterPanel() {
    ...
    const tabs = [
      { id: "options", label: "OPCJE", builder: () => this.createOptionsSection() },
      { id: "filters", label: "FILTRY ALBUMÓW", builder: () => this.createFiltersOverviewSection() },
  ...
  createFiltersOverviewSection() {
    const wrapper = document.createElement("div");
    wrapper.className = "filter-section";
    const intro = document.createElement("p");
    intro.className = "filter-overview";
    intro.textContent = "Wybierz zakładkę powyżej, aby dopasować konkretne ustawienia lub operacje.";
  ...
  createOptionsSection() {
    const wrapper = document.createElement("div");
    wrapper.className = "filter-section filter-section--options";
    wrapper.appendChild(this.createSectionTitle("Opcje"));
  ...
  clearAllFilters() {
    ...
    this.uiState.selectedLabels = new Set(Array.from(LABEL_MAP.keys()));
    this.uiState.selectedSelectors = new Set(SELECTOR_VALUES);
  ...
  updateNavCounts() {
    ...
    if (originalCounter) originalCounter.textContent = `ORY_COPY - O ${copyCounts.originals}`;
    if (copyCounter) copyCounter.textContent = `ORY_COPY - C ${copyCounts.copies}`;
  }
