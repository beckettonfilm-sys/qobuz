...
class UiController {
  ...
  buildOptionsPanel() {
    ...
    this.dom.newFolderBtn = makeBtn("newFolderBtn", "+");
    this.dom.editFolderBtn = makeBtn("editFolderBtn", "E");
    this.dom.deleteFolderBtn = makeBtn("deleteFolderBtn", "-");
    this.dom.exportFolderBtn = makeBtn("exportFolderBtn", "⇩");
    this.dom.modeSwitch = makeBtn("modeSwitch", this.uiState.managementMode);
