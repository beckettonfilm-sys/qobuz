...
- Jeżeli tabela jest pusta, interfejs nadal się uruchomi, a przycisk „ODŚWIEŻ” spróbuje pobrać zawartość z bazy; zapis poprzez „ZAPISZ” aktualizuje rekordy w SQLite.
