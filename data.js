...
class DataStore {
  ...
  rebuildCategories(filters = null) {
    ...
    const { monthStartTs, monthEndTs, labelsSet, selectorsSet, searchKey, heardValue, durationMin, durationMax } =
      this.activeFilters;
  ...
  passesActiveFilters(albumLike) {
    ...
    const { monthStartTs, monthEndTs, labelsSet, selectorsSet, searchKey, durationMin, durationMax } =
      this.activeFilters;
    const allowedLabels = labelsSet || this.selectedLabels;
    const allowedSelectors = selectorsSet || this.selectedSelectors;
    if (!allowedLabels.has(album.label)) return false;
